  ...
  return (
    <div className="container mx-auto px-4">
      <div className="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        ...
        <div className="lg:ml-12 xl:mr-64">
          ...
          <div className="flex flex-wrap items-center mt-8">
            ...
            <div className="flex items-center space-x-4 mt-4 sm:mt-0 sm:ml-12">
          ...
          <p className="mt-12">
            ...
            Final Fantasy VII Remake rebuilds and expands the legendary RPG for
            today. The first game in this project will be set in the eclectic
            city of Midgar and presents a fully standalone gaming experience.
          </p>
          <div className="mt-12">
